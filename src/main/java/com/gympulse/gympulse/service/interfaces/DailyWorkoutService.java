...
public interface DailyWorkoutService {
     ...
     * @param dayOfWeek the day of the week for the workout @param exercises a list of exercises for the workout @return the created DailyWorkout
     */
     ...
     * @param id the ID of the daily workout @return an Optional containing the DailyWorkout if found, or empty if not
     */
    Optional<DailyWorkout> dailyWorkoutById(String id);

    /**
     * Finds a daily workout by the day of the week.
     * @param dayOfWeek the day of the week @return an Optional containing the DailyWorkout if found, or empty if not
     */
    Optional<DailyWorkout> findDailyWorkoutByDayOfWeek(String dayOfWeek);

    /**
     * Updates an existing daily workout.
     * @param id the ID of the daily workout to update @param dailyWorkoutRequest the new data for the daily workout @return the updated DailyWorkout
     */
