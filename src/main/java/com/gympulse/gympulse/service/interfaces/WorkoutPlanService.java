...
public interface WorkoutPlanService {
     ...
     * @param memberId the ID of the member @param trainerId the ID of the trainer @param startDate the start date of the workout plan @param endDate the end date of the workout plan @param dailyWorkouts the list of daily workouts @return the created WorkoutPlan
     */
