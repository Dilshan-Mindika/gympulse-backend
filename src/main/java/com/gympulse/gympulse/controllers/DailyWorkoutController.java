...
public class DailyWorkoutController {
    ...
    // get a specific daily workout by ID
    @GetMapping("/{id}")
    ...
    // get daily workout by day of the week
    ...
    // create a new daily workout plan
    @PostMapping
    ...
    // update an existing daily workout by ID
    @PutMapping("/{id}")
